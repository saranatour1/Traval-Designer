...
function DashBoard({ users }) {
  const { posts, selectedPost, setSelectedPost, editMode, setEditMode, editModeOn, deleteItem, handleFormSubmit } =
    usePosts(); // Use the custom hook usePosts
  ...
  return (
    <>
      ...
      {posts && (
        <DisplayPosts
          items={posts}
          onDeleteProp={(item) => deleteItem(item)}
